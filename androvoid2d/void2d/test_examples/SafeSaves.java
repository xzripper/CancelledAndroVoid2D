...
public class SafeSaves {
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        Sprite sprite = new Sprite(gameWindow, "src\\androvoid2d.void2d\\test_examples\\res\\sprite.png", new int[] {0, 0}, null);
        sprite.setSpriteSizeByImageSize();
        sprite.addSprite();

        HashMap<String, Object> oldSpritePositionsSave = SafeSave.loadData("src\\androvoid2d.void2d\\save.dat");
                ...
                new Consumer[] {
                        ...
                        (key) -> {
                            if(key.equals(KeyEvent.VK_RIGHT)) {
                                ...
                                SafeSave newSave = new SafeSave(dataToSave, "src\\androvoid2d.void2d\\save.dat");
